...
public class Plateau 
{
    ...
    public Plateau()
    {
        ...
        this.plateau = creationPlateau(creationListeCases());
    ...
    private ArrayList<Case> creationListeCases()
    {
        ArrayList<Case> listeCase = new ArrayList<Case>(); // tout les types de cases disponible sur le plateau
        ArrayList<Integer> listeNbCases = new ArrayList<Integer>(); // nombre de chaque type de case dans le plateau 

        CaseLigne caseLigne = new CaseLigne();
        listeCase.add(caseLigne);
        listeNbCases.add(12);

        CaseCoude caseCoude = new CaseCoude();
        listeCase.add(caseCoude);
        listeNbCases.add(20);
        ...
        for (int i = 0; i < listeNbCases.size(); i++)
            for (int j = 0; j < listeNbCases.get(i); j++)
    ...
    public void deplacerCase(Case c)
    {
        ...
        if (checkDeplacementCase(c.getPosition()) != null)
        {
            ...
            System.out.println("déplacement de case impossible");
    }
    ...
    public String toString()
    {
        ...
        /*for (int nbJoueur = 0; nbJoueur < this.listeJoueur.size(); nbJoueur++)
        {
            contenu += this.listeJoueur.get(nbJoueur) + "\n";
            contenu += this.listeJoueur.get(nbJoueur).getDeplacementPossible(getPlateau()) + "\n";
            contenu += this.listeJoueur.get(nbJoueur).getToutDeplacementPossible(getPlateau()) + "\n";
        }*/
